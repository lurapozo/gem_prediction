...
async def read_item(request: Request):
    """
    Renders the main page, provides data needed to create all the selects in
    the HTML.
    :param request:
    :return: the HTML to render the main page, ML model to predict the price of
    the Zircon, the types of cuts colors and
...
async def prediction(
    ...
    :return: the html to render the prediction, the name of the regression
